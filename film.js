const filmy = [
	{
		...
		premiera: dayjs('2019-04-08').format('D. M. YYYY'),
	},
	{
		id: 'promlceno',
		nazev: 'Promlčeno',
		...
		premiera: dayjs('2022-04-28').format('D. M. YYYY'),
	},
	{
		id: 'ona',
		nazev: 'Ona',
		...
		premiera: dayjs('2013-12-18').format('D. M. YYYY'),
	},
	{
		id: 'rrrrrrr',
		nazev: 'RRRrrrr!!!',
		...
		premiera: dayjs('2004-09-23').format('D. M. YYYY'),
	},
	{
		id: 'vlastnici',
		nazev: 'Vlastníci',
		...
		premiera: dayjs('2019-11-19').format('D. M. YYYY'),
	},
	{
		id: 'kimi',
		nazev: 'KIMI',
		...
		premiera: dayjs('2022-02-10').format('D. M. YYYY'),
	},
	{
		...
		premiera: dayjs('1971-10-01').format('D. M. YYYY'),
	},
	{
		...
		premiera: dayjs('2022-12-24').format('D. M. YYYY'),
	},
]


const lastClickedStar = 0
...
allStars.forEach((star, index) => {
  star.addEventListener('click', () => {
    lastClickedStar = index
    highlightStars(lastClickedStar)
    console.log(`Film je hodnocen počtem hvězdiček: ${lastClickedStar + 1}.`)
  })
...
const movieIdFromHash = window.location.hash.slice(1);
const selectedMovie = filmy.find(movie => movie.id === movieIdFromHash)

if (selectedMovie) {
  
  const titleElement = document.querySelector('.card-title');
  const descriptionElement = document.querySelector('.card-text');
  const posterElement = document.querySelector('card-img-top');

  titleElement.textContent = selectedMovie.nazev;
  descriptionElement.textContent = selectedMovie.popis;
 
posterElement.setAttribute('src', selectedMovie.plakat.url);
